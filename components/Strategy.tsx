...
const Strategy: React.FC = () => {
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900">NBA Europe Initiative</h2>
          <p className="text-gray-500">Strategic Cooperation Agreement (SCA) Status & Roadmap.</p>
      </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-6">
                <div className="flex">
                    ...
                    <div className="ml-4">
                        <h5 className="font-semibold text-gray-900">Strategic & Operational Lead</h5>
                ...
                <div className="flex">
                    ...
                    <div className="ml-4">
                        <h5 className="font-semibold text-gray-900">FC Inter / Oaktree</h5>
                        <ul className="text-sm text-gray-500 mt-1 list-disc list-inside">
            ...
            <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                        Objective to finalize and sign the Exclusive Strategic Cooperation Agreement within <span className="font-bold text-gray-900">15 business days</span>.
                    </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-center mb-2">
                        ...
                        <span className="text-sm font-semibold text-gray-700">External Counsel</span>
                    </div>
                    <p className="text-sm text-gray-600">
                        <span className="font-bold text-gray-900">Charles H. Baker</span> (Sidley Austin). Expert in global sports transactions (NBA, MLB) engaged to guide deal structuring.
                    </p>
                </div>
            </div>
        </div>
